...
def train_and_track():
    # The environment variable for the DagsHub token will be available automatically if set up correctly
    ...
    # Manually set the DAGSHUB_TOKEN environment variable to ensure it is used
    os.environ["DAGSHUB_TOKEN"] = dagshub_token

    # Setup DagsHub and MLflow
    dagshub.init("mlops-introduction", "ssime-git", mlflow=True)
